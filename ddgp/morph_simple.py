# ddgp/morph_simple.py (FINAL, CORRIGIDO)
# -*- coding: utf-8 -*-
"""
Morph Simple (pt-BR)
Versão determinística, segura, sem candidatos, compatível com Streamlit.
Corrige o erro .get() quando info é string.
"""
